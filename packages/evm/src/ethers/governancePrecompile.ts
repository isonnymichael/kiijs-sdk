 ...
 * @example
 * ```tsx
 * import { getGovernancePrecompileEthersV6Contract} from '@kiichain/kiijs-evm/ethers';
 ...
 * const depositResponse = await governancePrecompileContract.connect(signer).deposit('1', { value: 1 });
